...
<div>
	<section class="bg-neutral-100 dark:bg-neutral-900 transition-colors flex flex-col lg:flex-row items-center mt-15 mb-15 w-full max-w-6xl mx-auto justify-center font-mono px-4 ">
  		...
  		<div class="mt-6 lg:mt-0 lg:pl-16 text-center lg:text-left text-neutral-900 dark:text-neutral-100 transition-colors">
    		...
    		<a href="/bhill_resume.pdf" class="button bg-neutral-900 text-neutral-100 dark:bg-neutral-100 dark:text-neutral-900 inline-block px-6 py-2 font-mono text-sm font-bold transition-colors duration-200" target="_blank" rel="noopener noreferrer">Resume PDF</a>
  		</div>
	</section>
</div>
